...
namespace ST10281928_NDIVHUWO_NDOU_EventEase_CLDV6211.Data;
...
public partial class EventEaseDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BookingId).HasName("PK__Booking__73951ACDF51C4121");
        ...
        {
            entity.HasKey(e => e.EventId).HasName("PK__Event__7944C87061242CFD");
        ...
        {
            entity.HasKey(e => e.VenueId).HasName("PK__Venue__3C57E5D26456B5F6");
